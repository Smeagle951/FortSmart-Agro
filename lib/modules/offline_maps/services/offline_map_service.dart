...
class OfflineMapService {
  ...
  Future<OfflineMapModel> createOfflineMap({
    ...
    await _databaseService.insertData('offline_maps', offlineMap.toMap());
    return offlineMap;
  }

  /// Lista todos os mapas offline
  Future<List<OfflineMapModel>> getAllOfflineMaps() async {
    final maps = await _databaseService.queryData(
      'offline_maps',
  ...
  Future<void> cleanupOldMaps({int daysOld = 30}) async {
    ...
    final oldMaps = await _databaseService.queryData(
      'offline_maps',
