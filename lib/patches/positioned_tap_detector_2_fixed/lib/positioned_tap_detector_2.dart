...
// Totalmente compatível com flutter_map 3.1.0
...
class PositionedTapDetector2State extends State<PositionedTapDetector2> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onSecondaryTapUp: widget.onSecondaryTap != null ? _handleSecondaryTap : null,
      child: widget.child,
    );
  }
}
...
// Classe que o flutter_map 3.1.0 espera
...
class TapPosition {
  ...
  @override
  // Aqui está a correção para o problema de null safety
