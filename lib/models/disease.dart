import '../database/models/disease.dart' as db;
...
class Disease {
  ...
  final List<int>? cropIds; // IDs das culturas que esta doença afeta
  final bool isSynced;
  ...
  factory Disease.fromDbModel(db.Disease dbModel) {
    return Disease(
      id: dbModel.id,
      name: dbModel.name,
  ...
  static List<Disease> fromDbModelList(List<db.Disease> dbModels) {
    return dbModels.map((dbModel) => Disease.fromDbModel(dbModel)).toList();
  }
