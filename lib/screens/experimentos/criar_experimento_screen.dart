...
/// Tela para criar novo experimento
/// Segue o padrão visual do FortSmart Agro
class CriarExperimentoScreen extends StatefulWidget {
  final String? talhaoId;
  final String? talhaoNome;

  const CriarExperimentoScreen({
    super.key,
    this.talhaoId,
    this.talhaoNome,
  });
  ...
  @override
  State<CriarExperimentoScreen> createState() => _CriarExperimentoScreenState();
}

class _CriarExperimentoScreenState extends State<CriarExperimentoScreen> {
  ...
  void initState() {
    ...
    if (widget.talhaoNome != null) {
      _plotNameController.text = widget.talhaoNome!;
    }
  }
  ...
  Future<void> _salvarExperimento() async {
    ...
    try {
      ...
      await _experimentService.createExperiment(experimento);
      ...
      if (mounted) {
        SnackbarUtils.showErrorSnackBar(context, 'Erro ao criar experimento: $e');
      }
    } finally {
      if (mounted) {
        setState(() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Preencha as informações para criar um novo experimento',
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: FortsmartButton(
                text: _isSaving ? 'Salvando...' : 'Criar Experimento',
