...
enum JarTestResult {
  ok('OK', 'Compatível', Colors.green),
  precipitation('Precipitação', 'Formação de precipitado', Colors.red),
  foam('Espuma', 'Espuma excessiva', Colors.orange),
  separation('Separação', 'Separação de fases', Colors.red),
  colorChange('Mudança de Cor', 'Alteração na cor', Colors.orange),
  other('Outro', 'Outro problema', Colors.grey);

  const JarTestResult(this.label, this.description, this.color);
...
class JarTestScreen extends StatefulWidget {
  ...
  @override
  State<JarTestScreen> createState() => _JarTestScreenState();
}

class _JarTestScreenState extends State<JarTestScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.info_outline, color: _testResult.color),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
