...
class _TopoRetratilFormPremiumState extends State<TopoRetratilFormPremium> 
  ...
  String? _getValidCulturaValue() {
    ...
    if (widget.culturaSelecionada == null) return widget.culturaOpcoes.first.id;
    
    bool valorExiste = widget.culturaOpcoes.any((cultura) => cultura.id == widget.culturaSelecionada);
    return valorExiste ? widget.culturaSelecionada : widget.culturaOpcoes.first.id;
  }
                                        ...
                                        Hero(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              gradient: LinearGradient(
                                                colors: [
                                                  _hexToColor(cultura.cor),
                                                  _hexToColor(cultura.cor).withOpacity(0.8),
                                                ],
                                              ),
                                              shape: BoxShape.circle,
                                              boxShadow: [
                                                BoxShadow(
                                                  color: _hexToColor(cultura.cor).withOpacity(0.4),
                                                  blurRadius: 4,
                                                  spreadRadius: 0,
                                                ),
                                              ],
                                            ...
                                            child: Center(
                                              child: Text(
                                                (cultura.nome.isNotEmpty) 
                                                  ? cultura.nome[0].toUpperCase() 
                                                  : '-',
